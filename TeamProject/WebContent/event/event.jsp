 ...
 <!--내 위치(위쪽여백)-->
  ...
  <div class="w3-container w3-padding-32" id="projects">
	...
	<div class="w3-col l3 w3-margin-bottom">
      <a href="./Event.do?flag=event1" class="w3-btn" style="padding: 3px">
	      <div class="w3-display-container">
		    <div class="w3-display-topleft w3-blue w3-padding">호스트이벤트</div>
		    <img src="event/e_img/e_img4.jpg" alt="event" style="width:100%">
	      </div>
      </a> 
	...
	<div class="w3-col l3 w3-margin-bottom">
      <a href="./Event.do?flag=event2" class="w3-btn" style="padding: 3px">
	      <div class="w3-display-container">
		    <div class="w3-display-topleft w3-blue w3-padding">첫후기쓰고 쿠폰받자</div>
		    <img src="event/e_img/e_img2.jpg" alt="event" style="width:100%">
	      </div>
      </a>
      <h6 class="w3-border-bottom w3-border-light-grey w3-padding-16">
    ...
    <div class="w3-col l3 w3-margin-bottom">
      <a href="./Event.do?flag=event3" class="w3-btn" style="padding: 3px">
	      <div class="w3-display-container">
		     <div class="w3-display-topleft w3-blue w3-padding">친구랑 쿠폰나눠쓰기</div>
		     <img src="event/e_img/e_img3.jpg" alt="event" style="width:100%">
	      </div>
      </a>
      <h6 class="w3-border-bottom w3-border-light-grey w3-padding-16">
	...
	<div class="w3-col l3 w3-margin-bottom">
      <a href="./Event.do?flag=event4" class="w3-btn" style="padding: 3px">
	      <div class="w3-display-container">
		    <div class="w3-display-topleft w3-blue w3-padding">회원가입 이벤트</div>
		    <img src="event/e_img/e_img1.jpg" alt="event" style="width:100%">
	      </div>
      </a>
      <h6 class="w3-border-bottom w3-border-light-grey w3-padding-16">
