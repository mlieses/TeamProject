...
%>
  ...
  <div class="w3-row-padding" id="bxslider">
	...
	%>
	 ...
	 <div class="w3-col l4 w3-margin-bottom">
      <a href="m_detail?room_no=<%=recDTO.getRoom_no()%>" class="w3-btn" style="padding: 0px">
	      <div class="w3-display-container">
		    <div class="w3-display-topleft w3-white w3-padding" style="opacity:0.8">
		    ...
		    <img src="upload/<%=recDTO.getPic1()%>" alt="House" style="width:100%; height: 350px;" >
	      </div>
      </a>
      </div>
...
%>
  <div class="w3-row-padding">
	...
	%>
	  <div class="w3-col l4 w3-margin-bottom">
      <a href="m_detail?room_no=<%=popDTO.getRoom_no()%>" class="w3-btn" style="padding: 0px">
	      <div class="w3-display-container">
		    <div class="w3-display-topleft w3-white w3-padding" style="opacity:0.8">
		    ...
		    <img src="upload/<%=popDTO.getPic1()%>" alt="House" style="width:100%; height: 350px;">
<!-- 		    <img src="img/room03.jpg" alt="House" style="width:100%"> -->
	      </div>
      </a>
      </div>
